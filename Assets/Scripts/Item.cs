    ...
    public void Interact()
    {
        switch (interactType)
        {
            case InteractionType.PickUp:
                ...
                Object.FindAnyObjectByType<InventorySystem>().PickUp(gameObject);
                //Disable
                gameObject.SetActive(false);
                break;
            case InteractionType.Examine:
                //Call the Examine item in the interaction system
                Object.FindAnyObjectByType<InteractionSystem>().ExamineItem(this);
                break;
            case InteractionType.GrabDrop:
                //Grab interaction
                Object.FindAnyObjectByType<InteractionSystem>().GrabDrop();
                break;
            default:
                Debug.Log("NULL ITEM");
                break;
